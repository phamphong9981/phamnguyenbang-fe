...
import { useUpdateChapter } from '@/hooks/useAdminCourse';
...
export default function EditChapterModal({ isOpen, chapter, onClose, onSuccess }: EditChapterModalProps) {
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 text-white">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="text-xl font-bold">Chỉnh sửa chương học</h3>
                                <p className="text-purple-100 text-sm">Cập nhật thông tin chương học</p>
                            </div>
                        </div>
                        <button
                            onClick={handleClose}
                        ...
                        <div className="mt-4 bg-red-50 border border-red-200 rounded-lg p-3">
                            <div className="flex items-center">
                                ...
                                <p className="text-red-700 text-sm">
                                    Có lỗi xảy ra khi cập nhật chương học. Vui lòng thử lại.
                                </p>
                            </div>
                        </div>
                    )}
