...
import { useUpdateGrade } from '@/hooks/useAdminCourse';
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 text-white">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="text-xl font-bold">Chỉnh sửa cấp độ</h3>
                                <p className="text-green-100 text-sm">Cập nhật thông tin cấp độ</p>
                            </div>
                        </div>
                        <button
                            onClick={handleClose}
                        ...
                        <div className="mt-4 bg-red-50 border border-red-200 rounded-lg p-3">
                            <div className="flex items-center">
                                ...
                                <p className="text-red-700 text-sm">
                                    Có lỗi xảy ra khi cập nhật cấp độ. Vui lòng thử lại.
                                </p>
                            </div>
                        </div>
                    )}
