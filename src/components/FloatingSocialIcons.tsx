    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 sm:w-14 h-10 sm:h-14 bg-black hover:bg-gray-800 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group"
                title="TikTok"
            >
                <svg className="w-7 sm:w-10 h-7 sm:h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
