...
export default function LoginPopup({ isOpen, onClose, onLoginSuccess }: LoginPopupProps) {
    ...
    return createPortal(
        <div
            className="fixed inset-0 bg-gradient-to-br from-black/60 via-gray-900/70 to-black/60 backdrop-blur-sm flex items-center justify-center z-[200] p-2 sm:p-4"
        >
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm sm:max-w-md max-h-[98vh] sm:max-h-[95vh] overflow-hidden transform transition-all duration-300 scale-100">
                ...
                <form onSubmit={handleSubmit} className="p-3 sm:p-4 space-y-2.5 sm:space-y-3 bg-gradient-to-b from-gray-50 to-white">
                    ...
                    <button
                        ...
                        className="w-full bg-gradient-to-r from-green-600 via-green-700 to-green-800 hover:from-green-700 hover:via-green-800 hover:to-green-900 disabled:from-gray-400 disabled:via-gray-500 disabled:to-gray-600 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl disabled:scale-100 disabled:shadow-lg shadow-lg flex items-center justify-center text-sm sm:text-base relative overflow-hidden group border-t border-green-200 mt-2"
                    >
