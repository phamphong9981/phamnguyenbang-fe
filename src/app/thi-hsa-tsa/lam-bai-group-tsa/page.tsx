...
function GroupExamPageContent() {
    ...
    const {
        ...
        isExamStarted && !isExamFinished && !isCurrentTabLocked,
    ...
    const handleNextQuestion = useCallback(() => {
        if (currentQuestionIndex < currentTabTotalQuestions - 1) {
            setCurrentQuestionIndex(currentQuestionIndex + 1);
            window.scrollTo({ top: 0, behavior: 'smooth' });
        }
    }, [currentQuestionIndex, currentTabTotalQuestions]);

    const handleNavigatorSelect = useCallback((index: number) => {
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <button
                        onClick={() => router.push('/thi-hsa-tsa/thi-tsa')}
