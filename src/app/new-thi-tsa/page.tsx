...
export default function TSAHomePage() {
	...
	const sets = [
		...
		{
			id: 'dot2',
			title: 'Thi thử Đánh giá Tư duy - Đợt 2',
			tag: 'TSA',
			mode: 'Tự do',
		...
		{
			id: 'dot3',
			title: 'Thi thử Đánh giá Tư duy - Đợt 3',
			tag: 'TSA',
			mode: 'Tự do',
			...
			<div className="mx-auto max-w-5xl p-6">
				<div className="flex items-center gap-4">
					<div className="flex items-center gap-3">
						...
						<h1 className="text-xl font-semibold text-gray-900">Tổng ôn - Luyện đề TSA</h1>
					</div>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  ...
                  onClick={() => router.push(`/new-thi-tsa/new-ket-qua-tsa`)}
                >
                    Xem kết quả
                </button>
								<button 
